...
//    CURLOPT_CAINFO      => 'e:/workspace/mongodb/src/fb_ca_chain_bundle.crt',//��ĵ�ַ tonghui
  );
   ...
   *����ӳ�䵽Facebook��
   * @var array
   * //�޸ĵ�URI graph.facebook.com��graph.beta.facebook.com��/ srcĿ¼/ base_facebook.php
   ...
   *�����˷�������,Ӧ������API���á�����*���ǵ�һ��,$ this - > accessToken������ȡ�
   *��*��Ч���û���������,������ΪӦ�ó��򡡡�
   *  �������������Ч���û��������Ʋ��ǿ��õġ���󡡡�*���÷����κη��صĵ�һ���绰��
   ...
   *���첢���ص�cookie�����ƿ��ܰ�������*
   *Ԫ���ݡ��趨�ı��ɲ���BaseFacebook��,���������ǡ���*�趨��JavaScript SDK��
  ...
  protected function makeRequest($url, $params, $ch=null) {
    ...
    if (isset($opts[CURLOPT_HTTPHEADER])) {
      $existing_headers = $opts[CURLOPT_SSL_VERIFYPEER];
      $existing_headers[] = 'Expect:';
      $opts[CURLOPT_HTTPHEADER] = array('Expect:');
    }
...
// 
class FacebookExp extends BaseFacebook
{
  /**
   * Cookie prefix
   */
  ...
  /**
   * Provides the implementations of the inherited abstract�ṩ�˼̳еĳ����ʵ��
   * methods. The implementation uses PHP sessions to maintain
   * a store for authorization codes, user ids, CSRF states, and
   * access tokens.
   * ʵ��ʹ��PHP�Ự���֡���*�̵���Ȩ��,�û�id,CSRF״̬, ����*�������ơ�
   */
  ...
  /**
   * Deletes Shared session cookieɾ����Ựcookie
   */
  ...
  /**
   * Returns the Shared session cookie name���ع���Ựcookie�����
   *
   ...
   * @return string The Shared session cookie name
   */
  public function my_getAccessTokenFromCode($code, $redirect_uri = null){
  	 return $this->getAccessTokenFromCode($code, $redirect_uri = null);
  }
}