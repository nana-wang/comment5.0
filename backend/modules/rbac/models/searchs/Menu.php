...
/**
 * Menu represents the model behind the search form about
 * [[\mdm\admin\models\Menu]].
 *
...
class Menu extends MenuModel {
    ...
    public function search ($params) {
        $query = MenuModel::find()->from(MenuModel::tableName() . ' t')->joinWith(
                [
        ...
        $sort->attributes['order'] = [
                ...
                'desc' => [
                        'parent.order' => SORT_DESC,
                        't.order' => SORT_DESC
                ],
                'label' => 'order'
        ];
        $sort->defaultOrder = [
                'menuParent.name' => SORT_ASC
        ];
