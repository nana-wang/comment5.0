		...
		<div class="col-sm-12">
			<div class="box box-primary">
				<div class="box-header with-border">
					<h3 class="box-title">敏感词视图<?=Yii::t('backend','Detailed Infor');?></h3>
				...
				<div class="box-body">
						...
						<div class="form-group col-md-3">
							<label>用户id</label> <input type="text" disabled class="form-control"
								value="<?php echo $model->comment_user_id;?>" >
						</div>
						<div class="form-group col-md-3">
							<label>来源</label> <input type="text" disabled class="form-control"
								value="<?php echo $model->comment_device;?>" >
						</div>
						<!-- textarea -->
						<div class="form-group col-md-12">
							<label><?=Yii::t('backend','New content');?></label>
							<?php $comment_content = $model->commentExp->comment_content;
							 $comment_content = preg_replace("/审核/i", "<font color=red><b>审核</b></font>", $comment_content);
							?>
							<?php echo  Html::decode($comment_content);?>
						</div>
						<?php  
