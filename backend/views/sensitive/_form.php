...
?>
<?php $release = Yii::t('backend','Release');?>
<?php $updates = Yii::t('backend','Updates');?>
<div class="row">
    <?php $form = ActiveForm::begin(); ?>
    <div class="col-lg-9">
        <div class="nav-tabs-custom">
            <ul class="nav nav-tabs">
                <li class="active"><a href="#tab_1" data-toggle="tab" aria-expanded="true"><?=Yii::t('backend','Currency');?></a></li>
                <?php if ($moduleModel): ?>
                <li><a href="#tab_2" data-toggle="tab" aria-expanded="true"><?=Yii::t('backend','Extends');?></a></li>
                <?php endif; ?>
            </ul>
    ...
    <div class="col-lg-3">
        ...
        <div class="form-group">
            <?= Html::submitButton($model->isNewRecord ? $release : $updates, ['class' => 'btn bg-maroon btn-flat btn-block']) ?>
        </div>
