    ...
    <div class="col-lg-9">
        <div class="nav-tabs-custom">
            <ul class="nav nav-tabs">
                <li class="active"><a href="#tab_1" data-toggle="tab" aria-expanded="true"><?=Yii::t('backend','Search Operation');?>通用</a></li>
                <?php if ($moduleModel): ?>
                <li><a href="#tab_2" data-toggle="tab" aria-expanded="true"><?=Yii::t('backend','Search Operation');?>扩展</a></li>
                <?php endif; ?>
            </ul>
