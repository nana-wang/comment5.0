...
$(function() {
    ...
    $("#report_add").click(function() {
        ...
        $("#show_loading").show();
        window.location.href='index.php?r=report/index&report_status='+report_status+'&report_idtype='+report_idtype+'&report_from_uid='+report_from_uid+'&report_uid='+report_uid+'&start_time='+start_time+'&end_time='+end_time+'&report_content='+report_content;
    });
});
