...
$this->title = Yii::t('backend','Report Replacement');
$this->params['breadcrumbs'][] = [
	'label' => Yii::t('backend','Report Replacement'),
	'url' => [
		'replace'
	]
];
						...
						<div class="box box-default collapsed-box">
							...
							<div class="box-body">
								<div class="form-group col-md-9">
									<fieldset>
										<?=Yii::t('backend','Replace Text');?>: <input type="text" class="form-control" id='name'>
									</fieldset>
								</div>
								<div class="form-group col-md-9">
									<fieldset>
								...
								<button type="button" id="replace_add"
					...
					<div class="col-md-12">
						<div class="box box-default box-default-edit collapsed-box">
							...
							<div class="box-body box-body-edit">
								...
								<div class="form-group col-md-9">
									<fieldset>
										<?=Yii::t('backend','Replace Text');?>: <input type="text" class="form-control" id='re_replace_content'>
										<input type="hidden" class="form-control" id='view_id'>
									</fieldset>
								</div>


								<button type="button" id="replace_edit" class="btn btn-block btn-info"></button>
							</div>
							<!-- /.box-body -->
						</div>
						<!-- /.box -->
			...
			<div class="box box-default">
				...
				<div class="box-body">
					<?= GridView::widget([
						...
						'columns' => [
							'id',
							'report_replace_content',
							[
								'attribute' => 'report_replace_create',
								'label'=>Yii::t('backend','Creat Time'),
								'value'=>
									function($model){
										return  date('Y-m-d H:i',$model->report_replace_create);
									},
							],
							[
							...
							['class' => 'yii\grid\ActionColumn',
								...
								'buttons' => [
									'view' => function ($url, $model) {
										...
										return '<a  class="rview" data="'.$model->id.'" href="javascript:void(0);" title="'.$view.'" aria-label="'.$view.'"><span class="glyphicon glyphicon-eye-open"></span></a>';
									},
									'delete' => function ($url, $model) {
										return '<a  class="view_del" data="'.$model->id.'" href="javascript:void(0);" title="删除" aria-label="删除"><span class="glyphicon glyphicon-trash"></span></a>	';
									}
								],
...
AppAsset::addScript($this,'@web/static/js/report_replace.js');
?>